 ...
 *     Allows kingship transfer to any valid address except zero or this contract, also renouncing kingship to the zero address
...
abstract contract Kingable {
    ...
    /// @notice Thrown for invalid new king address (zero or this contract address).
    ...
    /// @dev Reverts if new king is the same, zero or this contract.
    /// @param _newKingAddress The new king's address.
