 ...
 *         Allows kingship transfer to any valid address except address zero or this contract, also renounces kingship to the zero address
...
import {KingAccessControlLite} from "./KingAccessControlLite.sol";

abstract contract Kingable is KingAccessControlLite {
    // ----------------------------------------------------------- Custom Errors --------------------------------------------------
    ...
    /// @dev Reverts if new king is the same, zero or this contract address.
    /// @param _newKingAddress The new king's address.
    ...
    function _renounceKingship() internal onlyKing {
        ...
        // Assign zero address as the new king.
        s_king = address(0);
